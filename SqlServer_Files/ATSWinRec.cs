...
{
    public class ATSWinRec : TelemetryDataFile
    {
        public ATSWinRec(string path) : base(path) { }
        public ATSWinRec(Byte[] bytes) : base(bytes) { }
        public ATSWinRec(Stream stream) : base(stream) { }

        public override bool IsValidData
        {
            get
            {
                return Lines[1].StartsWith("Generated By: ATSWinRec_C v.109;");
            }
            //FIXME - also check for a valid data line
        }
